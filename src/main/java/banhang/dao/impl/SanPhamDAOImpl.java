...
//    private final String findAllSql = "SELECT * FROM SANPHAM";
    private final String findAllSql = "SELECT sp.*, lsp.TENLOAI FROM SANPHAM sp JOIN LOAISANPHAM lsp ON sp.MALOAI = lsp.MALOAI";
...
//    private final String findByMaLoaiSql = "SELECT * FROM SANPHAM WHERE MALOAI=?";
    private final String findByMaLoaiSql = "SELECT sp.*, lsp.TENLOAI FROM SANPHAM sp JOIN LOAISANPHAM lsp ON sp.MALOAI = lsp.MALOAI WHERE sp.MALOAI=?";
